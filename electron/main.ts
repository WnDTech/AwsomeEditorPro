...
const template: Electron.MenuItemConstructorOptions[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: 'Noise Gate...', click: () => mainWindow?.webContents.send('menu:fx-noisegate') },
      { type: 'separator' },
      { label: 'Reverb...', click: () => mainWindow?.webContents.send('menu:fx-reverb') },
      { label: 'Delay / Echo...', click: () => mainWindow?.webContents.send('menu:fx-delay') },
      { label: 'Chorus...', click: () => mainWindow?.webContents.send('menu:fx-chorus') },
      { label: 'Flanger...', click: () => mainWindow?.webContents.send('menu:fx-flanger') },
      { label: 'Phaser...', click: () => mainWindow?.webContents.send('menu:fx-phaser') },
      { type: 'separator' },
      { label: 'Distortion...', click: () => mainWindow?.webContents.send('menu:fx-distortion') },
      { label: 'Tremolo...', click: () => mainWindow?.webContents.send('menu:fx-tremolo') },
      { label: 'Vibrato...', click: () => mainWindow?.webContents.send('menu:fx-vibrato') },
      { type: 'separator' },
      { label: 'Pitch Shift...', click: () => mainWindow?.webContents.send('menu:fx-pitchshift') },
      { label: 'Time Stretch...', click: () => mainWindow?.webContents.send('menu:fx-timestretch') },
      { label: 'Speed Change...', click: () => mainWindow?.webContents.send('menu:fx-speedchange') },
      { type: 'separator' },
  ...
  },
  {
    ...
    submenu: [
      ...
      { type: 'separator' },
      { label: 'DTMF Tones...', click: () => mainWindow?.webContents.send('menu:gen-dtmf') },
      { label: 'Frequency Sweep...', click: () => mainWindow?.webContents.send('menu:gen-sweep') },
    ],
  },
  {
    label: 'Help',
